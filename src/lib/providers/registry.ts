...
export const MODELS: ModelEntry[] = [
  ...
  { id: 'seedance25-480', task: 'video.i2v', endpoint: 'bytedance/seedance-2.5/image-to-video', label: 'Seedance 2.5 (480p)', tier: 'ultra', unit: 'second', usdPerUnit: 0.2205, creditsPerUnit: 25, verified: false, priceSource: 'list', note: 'เสียงในตัว ยาวได้ 30 วิ · 720p $0.473/s' },
  { id: 'seedance25-ref', task: 'video.reference', endpoint: 'bytedance/seedance-2.5/reference-to-video', label: 'Seedance 2.5 Reference (รูป+วิดีโอ+เสียง)', tier: 'ultra', unit: 'second', usdPerUnit: 0.2205, creditsPerUnit: 25, verified: false, priceSource: 'list', note: 'อ้างอิงหลายไฟล์พร้อมกัน — ฐานของ reference editing เฟส 2' },
