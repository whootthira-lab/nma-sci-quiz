...
export const MODELS: ModelEntry[] = [
  ...
  // MiniMax H3 (Hailuo 03): native stereo audio in the same pass, 24 fps, 5–15 s. Known for the handheld / phone-camera / UGC look ("amateur" aesthetic) — Standard-mode content only, safety checker stays on.
  { id: 'minimax-h3-i2v', task: 'video.i2v', endpoint: 'minimax/h3/image-to-video', label: 'MiniMax H3 (ลุคมือถือ/UGC, มีเสียงในตัว)', tier: 'pro', unit: 'second', usdPerUnit: 0.06, creditsPerUnit: 7, verified: true, priceSource: 'list', note: 'พิสูจน์ 10 ก.ย.: plate ห้องสมุด + prompt handheld → 5.18s 1344×768 24fps + AAC stereo ใน 192s · ราคาป้าย 480P $0.05 · 768P $0.06 · 2K $0.13 · 4K $0.16 ต่อวินาที (2K/4K = upscale จาก 768P) · ฟิลด์: prompt, image_url?, end_image_url?, duration 5–15, resolution, prompt_expansion_mode fast|balanced|quality, enable_safety_checker' },
  { id: 'minimax-h3-t2v', task: 'video.t2v', endpoint: 'minimax/h3/text-to-video', label: 'MiniMax H3 Text-to-Video', tier: 'pro', unit: 'second', usdPerUnit: 0.06, creditsPerUnit: 7, verified: true, priceSource: 'list', note: 'พิสูจน์ 10 ก.ย.: prompt handheld library 16:9 → 5.18s 1344×768 24fps + AAC ใน ~190s · เพิ่ม aspect_ratio 21:9|16:9|4:3|1:1|3:4|9:16' },
  { id: 'minimax-h3max-i2v', task: 'video.i2v', endpoint: 'minimax/h3-max/image-to-video', label: 'MiniMax H3 Max', tier: 'pro', unit: 'second', usdPerUnit: 0.08, creditsPerUnit: 10, verified: false, priceSource: 'list', note: 'fal post-trained ตาม prompt แม่นกว่า · 480P $0.05 · 768P $0.08 · 1080P $0.16 (ลด 75% ถึง 14 ก.ย.) · ยังไม่ยิงจริง' },
  ...
  // Ultra-tier text-to-image — each proved 5 ก.ย. 2569 with a real render (see generate-image TOP_T2I)
  { id: 'flux11-ultra', task: 'image.t2i', endpoint: 'fal-ai/flux-pro/v1.1-ultra', label: 'Flux 1.1 Pro Ultra', tier: 'ultra', unit: 'image', usdPerUnit: 0.06, creditsPerUnit: 7, verified: true, priceSource: 'list', note: 'พิสูจน์ 5 ก.ย.: 2752×1536 ใน 26 วิ · ภาพถ่ายสมจริงระดับ 4MP' },
  { id: 'nanopro-t2i', task: 'image.t2i', endpoint: 'fal-ai/nano-banana-pro', label: 'Nano Banana Pro (Gemini 3 Pro Image)', tier: 'ultra', unit: 'image', usdPerUnit: 0.15, creditsPerUnit: 15, verified: true, priceSource: 'list', note: 'พิสูจน์ 5 ก.ย.: 1376×768 @1K ใน 35 วิ · เก่งข้อความในภาพ/คำสั่งซับซ้อน · มี 2K/4K' },
  { id: 'seedream45', task: 'image.t2i', endpoint: 'fal-ai/bytedance/seedream/v4.5/text-to-image', label: 'Seedream 4.5', tier: 'pro', unit: 'image', usdPerUnit: 0.04, creditsPerUnit: 4, verified: true, priceSource: 'list', note: 'พิสูจน์ 5 ก.ย. · หน้าคนเอเชียสมจริง · ByteDance' },
  { id: 'gptimage15', task: 'image.t2i', endpoint: 'fal-ai/gpt-image-1.5', label: 'GPT Image 1.5', tier: 'ultra', unit: 'image', usdPerUnit: 0.045, creditsPerUnit: 6, verified: true, priceSource: 'measured', note: 'พิสูจน์ 5 ก.ย. quality=medium 1536×1024 · ตามคำสั่ง/ตัวอักษรแม่น · high แพงกว่ามาก' },
  { id: 'gptimage2', task: 'image.t2i', endpoint: 'fal-ai/gpt-image-2', label: 'GPT Image 2 (OpenAI ล่าสุด)', tier: 'ultra', unit: 'image', usdPerUnit: 0.096, creditsPerUnit: 10, verified: true, priceSource: 'measured', note: 'พิสูจน์ 5 ก.ย. quality=medium landscape_16_9 → 1088×608 ใน 44 วิ $0.096 · quality=high แพงกว่าและใหญ่กว่า · มี /edit ด้วย (ยังไม่พิสูจน์)' },
  { id: 'flux2-max', task: 'image.t2i', endpoint: 'fal-ai/flux-2-max', label: 'Flux 2 Max', tier: 'ultra', unit: 'image', usdPerUnit: 0.06, creditsPerUnit: 7, verified: true, priceSource: 'measured', note: 'พิสูจน์ 5 ก.ย. · Flux 2 รุ่นสูงสุด' },
  ...
  { id: 'char-motion-control', task: 'vfx.character', endpoint: 'fal-ai/kling-video/v2.6/standard/motion-control', label: 'เปลี่ยนตัวละคร (Kling Motion Control)', tier: 'pro', unit: 'second', usdPerUnit: 0.068, creditsPerUnit: 8, verified: true, priceSource: 'measured', note: 'พิสูจน์ 5 ก.ย.: ภาพชาย + ฟุตเทจครู 7.2s → ชายทำท่า/สีหน้า/พูดตามฟุตเทจ 816×1104 ใน 364s $0.49 · เฟรมแน่นกว่าต้นฉบับตามภาพอ้างอิง (ควรใช้ภาพครึ่งตัว) · ฉากหลังมาจากภาพอ้างอิง → ส่งต่อ matte/composite · ต้องมี consent record' },
  { id: 'char-o3-element', task: 'vfx.character', endpoint: 'fal-ai/kling-video/o3/pro/video-to-video/edit', label: 'Kling O3 Element Edit (เปลี่ยนตัวละคร)', tier: 'ultra', unit: 'second', usdPerUnit: 0.163, creditsPerUnit: 19, verified: false, priceSource: 'bill', note: 'ยิงจริง 5 ก.ย. ($1.18, 7.2s): งานสำเร็จแต่ "ไม่เปลี่ยนคน" — ได้ผู้หญิงคนเดิมเรนเดอร์ใหม่ แม้ส่ง elements + prompt แทนที่ @Element1 · ไม่ใช่การปฏิเสธนโยบาย · ยังไม่เปิดใช้' },
