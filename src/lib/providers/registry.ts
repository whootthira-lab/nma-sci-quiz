...
export const MODELS: ModelEntry[] = [
  ...
  { id: 'minimax-h3-t2v', task: 'video.t2v', endpoint: 'minimax/h3/text-to-video', label: 'MiniMax H3 Text-to-Video', tier: 'pro', unit: 'second', usdPerUnit: 0.06, creditsPerUnit: 7, verified: false, priceSource: 'list', note: 'ราคาเดียวกับ i2v · เพิ่ม aspect_ratio 21:9|16:9|4:3|1:1|3:4|9:16' },
