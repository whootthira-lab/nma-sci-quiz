...
export const VOICE_EMOTIONS: { id: string; label: string; instruction: string }[] = [
  ...
  { id: 'curious',   label: '🤔 สงสัย ชวนคิด',            instruction: 'พูดด้วยน้ำเสียงสงสัยใคร่รู้ ชวนคิดชวนถาม เว้นจังหวะให้คนฟังได้คิดตาม: ' },
  { id: 'sad',       label: '😢 เศร้า สะเทือนใจ',          instruction: 'พูดด้วยน้ำเสียงเศร้า แผ่วเบา สะเทือนใจ เหมือนเล่าเรื่องที่น่าเห็นใจ: ' },
  { id: 'angry',     label: '😤 โกรธ เคร่งเครียด',         instruction: 'พูดด้วยน้ำเสียงโกรธ เคร่งเครียด กดดัน เสียงแข็งขึ้นแต่ยังชัดถ้อยชัดคำ: ' },
];
